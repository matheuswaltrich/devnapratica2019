/* Database: PostgreSql. Generation date: 2019-06-11 17:33:07:544 */
/* Entity Cliente */
...
alter table pedido add constraint fkru4zmxzimencfrqmeibiwveuzhcy foreign key (cliente) references cliente (id);
alter table pedido_itens add constraint fkyxzvfctbow6spkyptubcteey1poc foreign key (pedido_id) references pedido (id);
alter table pedido_itens add constraint fkbosppc8bwwoz1vjjliz8in5n06up foreign key (itens_id) references item (id);
