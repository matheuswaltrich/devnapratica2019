...
public class ImportProfessorOutput {
    
    public String importJobId;
    
    public ImportProfessorOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ImportProfessorOutput(String importJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ImportProfessorOutput)) {
            return false;
        }
        ImportProfessorOutput other = (ImportProfessorOutput) obj;
