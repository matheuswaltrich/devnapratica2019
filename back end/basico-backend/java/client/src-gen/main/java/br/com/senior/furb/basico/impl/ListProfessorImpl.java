 ...
 * 
 */
public class ListProfessorImpl {
	...
	public ListProfessorImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(Professor.PageRequest input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.LIST_PROFESSOR, //
	...
	*/
	public Professor.PagedResults listProfessor(Professor.PageRequest input, long timeout) {
		...
		Professor.PagedResults output = DtoJsonConverter.toDTO(resultMessage.getContent(), Professor.PagedResults.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<Professor.PagedResults> listProfessorRequest(Professor.PageRequest input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, Professor.PagedResults.class);
	}
