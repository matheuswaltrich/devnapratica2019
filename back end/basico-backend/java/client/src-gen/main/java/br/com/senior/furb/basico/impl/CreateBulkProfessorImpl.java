 ...
 * 
 */
public class CreateBulkProfessorImpl {
	...
	public CreateBulkProfessorImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkProfessorInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.CREATE_BULK_PROFESSOR, //
	...
	*/
	public CreateBulkProfessorOutput createBulkProfessor(CreateBulkProfessorInput input, long timeout) {
		...
		CreateBulkProfessorOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkProfessorOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<CreateBulkProfessorOutput> createBulkProfessorRequest(CreateBulkProfessorInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkProfessorOutput.class);
	}
