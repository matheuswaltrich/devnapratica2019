 ...
 * 
 */
public class CreateBulkMateriaImpl {
	...
	public CreateBulkMateriaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkMateriaInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.CREATE_BULK_MATERIA, //
	...
	*/
	public CreateBulkMateriaOutput createBulkMateria(CreateBulkMateriaInput input, long timeout) {
		...
		CreateBulkMateriaOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkMateriaOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<CreateBulkMateriaOutput> createBulkMateriaRequest(CreateBulkMateriaInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkMateriaOutput.class);
	}
