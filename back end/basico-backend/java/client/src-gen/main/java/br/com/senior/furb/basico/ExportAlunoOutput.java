...
public class ExportAlunoOutput {
    
    public String exportJobId;
    
    public ExportAlunoOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ExportAlunoOutput(String exportJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExportAlunoOutput)) {
            return false;
        }
        ExportAlunoOutput other = (ExportAlunoOutput) obj;
