...
public class ExportTurmaOutput {
    
    public String exportJobId;
    
    public ExportTurmaOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ExportTurmaOutput(String exportJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExportTurmaOutput)) {
            return false;
        }
        ExportTurmaOutput other = (ExportTurmaOutput) obj;
