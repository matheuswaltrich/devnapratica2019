...
public class ExportProfessorOutput {
    
    public String exportJobId;
    
    public ExportProfessorOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ExportProfessorOutput(String exportJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExportProfessorOutput)) {
            return false;
        }
        ExportProfessorOutput other = (ExportProfessorOutput) obj;
