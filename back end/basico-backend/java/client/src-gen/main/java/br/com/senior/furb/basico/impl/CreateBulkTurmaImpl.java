 ...
 * 
 */
public class CreateBulkTurmaImpl {
	...
	public CreateBulkTurmaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkTurmaInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.CREATE_BULK_TURMA, //
	...
	*/
	public CreateBulkTurmaOutput createBulkTurma(CreateBulkTurmaInput input, long timeout) {
		...
		CreateBulkTurmaOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkTurmaOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<CreateBulkTurmaOutput> createBulkTurmaRequest(CreateBulkTurmaInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkTurmaOutput.class);
	}
