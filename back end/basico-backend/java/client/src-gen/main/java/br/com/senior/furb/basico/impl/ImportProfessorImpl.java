 ...
 * 
 */
public class ImportProfessorImpl {
	...
	public ImportProfessorImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ImportProfessorInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.IMPORT_PROFESSOR, //
	...
	*/
	public ImportProfessorOutput importProfessor(ImportProfessorInput input, long timeout) {
		...
		ImportProfessorOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ImportProfessorOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<ImportProfessorOutput> importProfessorRequest(ImportProfessorInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ImportProfessorOutput.class);
	}
