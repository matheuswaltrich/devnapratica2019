...
public class Aluno {
     ...
     */
    public Aluno(String id, String nome, java.time.LocalDate dataNascimento, String cpf, Boolean devedor) {
        this.id = id;
        this.nome = nome;
        this.dataNascimento = dataNascimento;
        this.cpf = cpf;
        this.devedor = devedor != null ? devedor : false;
    }
    /** 
     * This convenience constructor allows initialization of all required fields.
     */
    public Aluno(String nome, java.time.LocalDate dataNascimento, String cpf) {
        this.nome = nome;
        this.dataNascimento = dataNascimento;
        this.cpf = cpf;
    }
    ...
    void toString(StringBuilder sb, List<Object> appended) {
    	...
    	sb.append("devedor=").append(devedor == null ? "null" : devedor);
    	sb.append(']');
    }
