 ...
 * 
 */
public class ExportProfessorImpl {
	...
	public ExportProfessorImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ExportProfessorInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.EXPORT_PROFESSOR, //
	...
	*/
	public ExportProfessorOutput exportProfessor(ExportProfessorInput input, long timeout) {
		...
		ExportProfessorOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ExportProfessorOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<ExportProfessorOutput> exportProfessorRequest(ExportProfessorInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ExportProfessorOutput.class);
	}
