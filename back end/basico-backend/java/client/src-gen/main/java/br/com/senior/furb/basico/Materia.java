...
public class Materia {
    ...
    public static class PagedResults {
        ...
        public List<Materia> contents;
        
        public PagedResults() {
        }
        
        public PagedResults(List<Materia> contents) {
            this.contents = contents;
        }
        
        public PagedResults(List<Materia> contents, Long totalPages, Long totalElements) {
            this.contents = contents;
