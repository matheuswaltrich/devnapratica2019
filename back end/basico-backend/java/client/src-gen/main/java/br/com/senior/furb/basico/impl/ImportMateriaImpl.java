 ...
 * 
 */
public class ImportMateriaImpl {
	...
	public ImportMateriaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ImportMateriaInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.IMPORT_MATERIA, //
	...
	*/
	public ImportMateriaOutput importMateria(ImportMateriaInput input, long timeout) {
		...
		ImportMateriaOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ImportMateriaOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<ImportMateriaOutput> importMateriaRequest(ImportMateriaInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ImportMateriaOutput.class);
	}
