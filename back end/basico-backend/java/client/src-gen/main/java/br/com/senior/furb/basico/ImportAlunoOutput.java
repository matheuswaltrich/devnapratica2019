...
public class ImportAlunoOutput {
    
    public String importJobId;
    
    public ImportAlunoOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ImportAlunoOutput(String importJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ImportAlunoOutput)) {
            return false;
        }
        ImportAlunoOutput other = (ImportAlunoOutput) obj;
