...
public class ImportMateriaOutput {
    
    public String importJobId;
    
    public ImportMateriaOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ImportMateriaOutput(String importJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ImportMateriaOutput)) {
            return false;
        }
        ImportMateriaOutput other = (ImportMateriaOutput) obj;
