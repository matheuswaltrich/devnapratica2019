...
public class ImportTurmaOutput {
    
    public String importJobId;
    
    public ImportTurmaOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ImportTurmaOutput(String importJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ImportTurmaOutput)) {
            return false;
        }
        ImportTurmaOutput other = (ImportTurmaOutput) obj;
