 ...
 * 
 */
public class CreateBulkAlunoImpl {
	...
	public CreateBulkAlunoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkAlunoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.CREATE_BULK_ALUNO, //
	...
	*/
	public CreateBulkAlunoOutput createBulkAluno(CreateBulkAlunoInput input, long timeout) {
		...
		CreateBulkAlunoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkAlunoOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<CreateBulkAlunoOutput> createBulkAlunoRequest(CreateBulkAlunoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkAlunoOutput.class);
	}
