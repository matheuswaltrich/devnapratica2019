...
public class Professor {
     ...
     */
    public Professor(String id, String nome, java.time.LocalDate dataNascimento, String cpf) {
        this.id = id;
        this.nome = nome;
     ...
     */
    public Professor(String nome, java.time.LocalDate dataNascimento, String cpf) {
        this.nome = nome;
        this.dataNascimento = dataNascimento;
        this.cpf = cpf;
    }
