...
public class ExportMateriaOutput {
    
    public String exportJobId;
    
    public ExportMateriaOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ExportMateriaOutput(String exportJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExportMateriaOutput)) {
            return false;
        }
        ExportMateriaOutput other = (ExportMateriaOutput) obj;
