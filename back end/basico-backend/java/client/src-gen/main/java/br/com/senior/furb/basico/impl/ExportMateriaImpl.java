 ...
 * 
 */
public class ExportMateriaImpl {
	...
	public ExportMateriaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ExportMateriaInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.EXPORT_MATERIA, //
	...
	*/
	public ExportMateriaOutput exportMateria(ExportMateriaInput input, long timeout) {
		...
		ExportMateriaOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ExportMateriaOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<ExportMateriaOutput> exportMateriaRequest(ExportMateriaInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ExportMateriaOutput.class);
	}
